...
def test_DSPreservationTiff_profile():
    profile_builder = validation_profile.ProfileBuilder(validation_profile.get_profile_builder("DSPreservationTiff"))
    ...
    assert profile.file_extension == ".tif"


def test_DSHathiAccessTiff_profile():
    profile_builder = validation_profile.ProfileBuilder(validation_profile.get_profile_builder("DSHathiAccessTiff"))
    profile = profile_builder.build_profile()
    assert isinstance(profile, validation_profile.ValidationProfile)
